...
// Source: aten/src/ATen/native/cuda/hermite_polynomial_he.cu
...
namespace at::native {
        namespace {
            ...
            void hermite_polynomial_he_kernel_opencl(TensorIteratorBase& iterator) {
                AT_DISPATCH_FLOATING_TYPES(iterator.common_dtype(), "hermite_polynomial_he_opencl", [&]() {
            ...
            } // hermite_polynomial_he_kernel_opencl
        } // namespace (anonymous)

        REGISTER_DISPATCH(hermite_polynomial_he_stub, &hermite_polynomial_he_kernel_opencl)
} // namespace at::native
