...
// Source: aten/src/ATen/native/cuda/FusedSgdKernel.cu
...
C10_DEVICE inline void sgd_math(
...
struct FusedSgdMathFunctor {
  ...
  C10_DEVICE inline void operator()(
    ...
    if (use_faster_load_store) {
      for (auto i_start = item.get_local_id(0);
...
void _fused_sgd_with_momentum_kernel_cuda_(
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ...
      "fused_sgd_with_momentum_kernel_opencl",
      [&]() {
