...
// Source: aten/src/ATen/native/cuda/NaiveConvolutionTranspose2d.cu
...
void slow_conv_transpose2d_out_opencl_template(
    const Tensor& output,
    const Tensor& input,
    const Tensor& weight,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(kHalf, kBFloat16,
      input_.scalar_type(), "slow_conv_transpose2d_out_opencl", [&] {
...
static void slow_conv_transpose2d_backward_out_opencl_template(
    const Tensor& input_,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(kHalf, kBFloat16,
      grad_output.scalar_type(), "slow_conv_transpose2d_backward_out_opencl", [&] {
        // Helpers
...
void slow_conv_transpose2d_acc_grad_parameters_opencl_template(
    const Tensor& input_,
    const Tensor& grad_output_,
    Tensor& grad_weight,
    Tensor& grad_bias,
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(kHalf, kBFloat16,
      input.scalar_type(), "slow_conv_transpose2d_acc_grad_parameters_opencl", [&] {
        // Helpers
...
(const Tensor& input,
 ...
 const Tensor& output) {
  ...
  slow_conv_transpose2d_out_opencl_template(
      output,
      input,
      weight,
      kernel_size,
...
std::tuple<Tensor&, Tensor&, Tensor&> slow_conv_transpose2d_backward_out_opencl(const Tensor& grad_output,
    const Tensor& input,
    const Tensor& weight,
    IntArrayRef kernel_size,
    IntArrayRef stride,
  ...
  if (grad_input.defined()) {
    slow_conv_transpose2d_backward_out_opencl_template(
        input,
        grad_output,
        grad_input,
        weight,
  ...
  if (grad_weight.defined() || grad_bias.defined()) {
    slow_conv_transpose2d_acc_grad_parameters_opencl_template(
        input,
        grad_output,
        grad_weight,
        grad_bias,
...
std::tuple<Tensor, Tensor, Tensor> slow_conv_transpose2d_backward_opencl(
    const Tensor& grad_output,
    const Tensor& input,
    const Tensor& weight,
    IntArrayRef kernel_size,
...
REGISTER_OPENCL_DISPATCH(slow_conv_transpose2d_backward_stub, &slow_conv_transpose2d_backward_opencl)
