...
// Source: aten/src/ATen/native/cuda/ForeachPointwiseOp.cu
...
void foreach_pointwise_op_0d_tensor1_(
  ...
  AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND2(
      ...
      kBFloat16,
      input[0].scalar_type(),
      "foreach_pointwise_op_0d_tensor1__opencl",
      [&]() {
...
std::vector<Tensor> foreach_pointwise_op_0d_tensor1(
  ...
  AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND2(
      ...
      kBFloat16,
      input[0].scalar_type(),
      "foreach_pointwise_op_0d_tensor1_opencl",
      [&]() {
        using opmath_t = at::opmath_type<scalar_t>;
        multi_tensor_apply<4>(
            tensor_lists,
