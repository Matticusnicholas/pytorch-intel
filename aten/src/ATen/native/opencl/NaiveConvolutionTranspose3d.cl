...
// Source: aten/src/ATen/native/cuda/NaiveConvolutionTranspose3d.cu
...
#include <ATen/native/sycl/vol2col.h>
...
void slow_conv_transpose3d_out_opencl_template(
    Tensor& output,
    const Tensor& input_,
  ...
  checkAllSameGPU(
      "slow_conv_transpose3d_out_opencl",
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(kHalf, kBFloat16,
      input.scalar_type(), "slow_conv_transpose3d_out_opencl", [&] {
...
void slow_conv_transpose3d_backward_out_opencl_template(
    const Tensor& input_,
  ...
  checkAllSameGPU(
      "slow_conv_transpose3d_backward_out_opencl",
      {input_arg,
       grad_output_arg,
       weight_arg,
       grad_input_arg});
  ...
  AT_DISPATCH_FLOATING_TYPES_AND2(kHalf, kBFloat16,
      input.scalar_type(), "slow_conv_transpose3d_backward_out_opencl", [&] {
        // Helpers
        Tensor grad_input_n;
...
void slow_conv_transpose3d_acc_grad_parameters_cuda(
  ...
  checkAllSameGPU(
      "slow_conv_transpose3d_acc_grad_parameters_opencl",
      {input_arg,
       grad_output_arg,
       grad_weight_arg,
       grad_bias_arg});
...
Tensor& slow_conv_transpose3d_out_opencl(const Tensor& input,
    const Tensor& weight,
  ...
  slow_conv_transpose3d_out_opencl_template(
      output,
      input,
      weight,
      kernel_size,
...
std::tuple<Tensor&, Tensor&, Tensor&> slow_conv_transpose3d_backward_out_opencl(const Tensor& grad_output,
    const Tensor& input,
    const Tensor& weight,
    IntArrayRef kernel_size,
    IntArrayRef stride,
  ...
  if (grad_input.defined()) {
    slow_conv_transpose3d_backward_out_opencl_template(
        input,
        grad_output,
        grad_input,
        weight,
...
std::tuple<Tensor, Tensor, Tensor> slow_conv_transpose3d_backward_opencl(
    const Tensor& grad_output,
    const Tensor& input,
    const Tensor& weight,
    IntArrayRef kernel_size,
...
REGISTER_OPENCL_DISPATCH(slow_conv_transpose3d_backward_stub, &slow_conv_transpose3d_backward_opencl)
