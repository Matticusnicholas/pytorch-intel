...
// Source: aten/src/ATen/native/cuda/chebyshev_polynomial_u.cu
...
namespace at::native {
        namespace {
            ...
            void chebyshev_polynomial_u_kernel_opencl(TensorIteratorBase& iterator) {
                AT_DISPATCH_FLOATING_TYPES(iterator.common_dtype(), "chebyshev_polynomial_u_opencl", [&]() {
            ...
            } // chebyshev_polynomial_u_kernel_opencl
        } // namespace (anonymous)

        REGISTER_DISPATCH(chebyshev_polynomial_u_stub, &chebyshev_polynomial_u_kernel_opencl)
} // namespace at::native
