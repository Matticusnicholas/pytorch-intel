...
// Source: aten/src/ATen/native/cuda/ScaledGroupMM.cu
...
// SYCL: CUTLASS not available on Intel GPUs
...
void f8f8bf16_grouped_gemm_impl_sm90(
  ...
  at::cuda::detail::prepare_grouped_gemm_data/* SYCL: kernel launch with nd_range(1, group_count, 0, stream) */(
