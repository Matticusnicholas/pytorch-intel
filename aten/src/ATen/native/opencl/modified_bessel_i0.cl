...
// Source: aten/src/ATen/native/cuda/modified_bessel_i0.cu
...
void modified_bessel_i0_kernel_opencl(TensorIteratorBase& iterator) {
    AT_DISPATCH_FLOATING_TYPES(iterator.common_dtype(), "modified_bessel_i0_opencl", [&]() {
...
REGISTER_DISPATCH(special_modified_bessel_i0_stub, &modified_bessel_i0_kernel_opencl)
} // namespace at::native
