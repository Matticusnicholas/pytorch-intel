...
static inline scalar_t ceil_wrapper(scalar_t a) {
  return std::ceil(a);
}

template<typename T>
static inline std::complex<T> ceil_wrapper(std::complex<T> v) {
  return std::complex<T>(std::ceil(v.real()), std::ceil(v.imag()));
}

void ceil_kernel_opencl(TensorIteratorBase& iter) {
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ScalarType::Half, ScalarType::BFloat16,
      iter.dtype(), "ceil_opencl",
      [&]() {
...
void frac_kernel_opencl(TensorIteratorBase& iter) {
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ScalarType::Half, ScalarType::BFloat16,
      iter.dtype(), "frac_opencl",
      [&]() {
        sycl_kernel(iter, []SYCL_LAMBDA(scalar_t a) -> scalar_t {
          return a - ::trunc(a);
        });
...
template <typename scalar_t>
static inline scalar_t floor_wrapper(scalar_t a) {
  return std::floor(a);
}

template<typename T>
static inline std::complex<T> floor_wrapper(std::complex<T> v) {
  return std::complex<T>(std::floor(v.real()), std::floor(v.imag()));
}

void floor_kernel_opencl(TensorIteratorBase& iter) {
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ScalarType::Half, ScalarType::BFloat16,
      iter.dtype(), "floor_opencl",
      [&]() {
        sycl_kernel(iter, []SYCL_LAMBDA(scalar_t a) -> scalar_t {
...
template <typename scalar_t>
static inline scalar_t reciprocal_wrapper(scalar_t a) {
...
void reciprocal_kernel_opencl(TensorIteratorBase& iter) {
  AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(
      ScalarType::Half, ScalarType::BFloat16,
      iter.common_dtype(), "reciprocal_opencl",
      [&]() {
        sycl_kernel(iter, []SYCL_LAMBDA(scalar_t a) -> scalar_t {
...
static inline c10::complex<float> nearbyint_wrapper(c10::complex<float> a) {
  return c10::complex<float>(::nearbyintf(static_cast<float>(a.real())), ::nearbyintf(static_cast<float>(a.imag())));
}

static inline c10::complex<double> nearbyint_wrapper(c10::complex<double> a) {
  return c10::complex<double>(::nearbyint(static_cast<double>(a.real())), ::nearbyint(static_cast<double>(a.imag())));
}
#pragma pop

void round_kernel_opencl(TensorIteratorBase& iter) {
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ScalarType::Half, ScalarType::BFloat16,
      iter.dtype(), "round_opencl",
      [&]() {
        sycl_kernel(iter, []SYCL_LAMBDA(scalar_t a) -> scalar_t {
...
void round_decimals_kernel_opencl(TensorIteratorBase& iter, int64_t decimals) {
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ScalarType::Half, ScalarType::BFloat16,
      iter.dtype(), "round_opencl",
      [&]() {
        ...
        sycl_kernel(iter, [ten_pow_decimals, neg_flag]SYCL_LAMBDA(scalar_t a) -> scalar_t {
...
template <typename scalar_t>
static inline scalar_t trunc_wrapper(scalar_t a) {
  return static_cast<scalar_t>(::truncf(static_cast<float>(a)));
}

static inline double trunc_wrapper(double a) {
  return ::trunc(a);
}

static inline c10::complex<float> trunc_wrapper(c10::complex<float> a) {
  return c10::complex<float>(::truncf(static_cast<float>(a.real())), ::truncf(static_cast<float>(a.imag())));
}

static inline c10::complex<double> trunc_wrapper(c10::complex<double> a) {
  return c10::complex<double>(::trunc(static_cast<double>(a.real())), ::trunc(static_cast<double>(a.imag())));
}

void trunc_kernel_opencl(TensorIteratorBase& iter) {
  AT_DISPATCH_FLOATING_TYPES_AND2(
      ScalarType::Half, ScalarType::BFloat16,
      iter.dtype(), "trunc_opencl",
      [&]() {
        sycl_kernel(iter, []SYCL_LAMBDA(scalar_t a) -> scalar_t {
...
REGISTER_DISPATCH(frac_stub, &frac_kernel_opencl)
REGISTER_DISPATCH(floor_stub, &floor_kernel_opencl)
REGISTER_DISPATCH(reciprocal_stub, &reciprocal_kernel_opencl)
REGISTER_DISPATCH(round_stub, &round_kernel_opencl)
REGISTER_DISPATCH(round_decimals_stub, &round_decimals_kernel_opencl)
REGISTER_DISPATCH(trunc_stub, &trunc_kernel_opencl)
