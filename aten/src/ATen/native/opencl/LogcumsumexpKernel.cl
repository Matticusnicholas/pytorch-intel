...
// Source: aten/src/ATen/native/cuda/LogcumsumexpKernel.cu
...
void launch_logcumsumexp_opencl_kernel(const TensorBase& result, const TensorBase& self, int64_t dim) {
  AT_DISPATCH_FLOATING_AND_COMPLEX_TYPES_AND2(ScalarType::Half, ScalarType::BFloat16,
      self.scalar_type(), "logcumsumexp_opencl",
      [&]() {
