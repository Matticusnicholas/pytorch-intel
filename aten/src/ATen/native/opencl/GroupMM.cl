...
// Source: aten/src/ATen/native/cuda/GroupMM.cu
#define TORCH_ASSERT_ONLY_METHOD_OPERATORS
#include <ATen/Dispatch.h>
#include <ATen/core/Tensor.h>
#include <ATen/sycl/CUDAContext.h>
#include <ATen/sycl/nvrtc_stub/ATenNVRTC.h>
...
#if 1 // SYCL: always use unroll hints && !defined(_WIN32) && defined(CUDA_VERSION)
...
#include <ATen/native/sycl/GroupMMCommon.h>
...
#include <ATen/native/sycl/cutlass_common.h>
...
void bf16bf16_grouped_gemm_impl_sm90_sm100(
  ...
  auto stream = at::sycl::getCurrentSYCLStream().stream();
  ...
  at::cuda::detail::prepare_grouped_gemm_data/* SYCL: submit kernel with nd_range({grid=1, block=group_count, smem=0, stream=stream}) */(
  ...
  auto status = gemm(at::sycl::getCurrentSYCLStream());
  TORCH_CHECK(
