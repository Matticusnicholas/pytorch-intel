...
// Source: aten/src/ATen/native/cuda/bessel_j0.cu
...
void bessel_j0_kernel_opencl(TensorIteratorBase& iterator) {
    AT_DISPATCH_FLOATING_TYPES(iterator.common_dtype(), "bessel_j0_opencl", [&]() {
...
REGISTER_DISPATCH(special_bessel_j0_stub, &bessel_j0_kernel_opencl)
} // namespace at::native
