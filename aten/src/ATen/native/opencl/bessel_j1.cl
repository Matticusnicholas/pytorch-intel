...
// Source: aten/src/ATen/native/cuda/bessel_j1.cu
...
void bessel_j1_kernel_opencl(TensorIteratorBase& iterator) {
    AT_DISPATCH_FLOATING_TYPES(iterator.common_dtype(), "bessel_j1_opencl", [&]() {
...
REGISTER_DISPATCH(special_bessel_j1_stub, &bessel_j1_kernel_opencl)
} // namespace at::native
