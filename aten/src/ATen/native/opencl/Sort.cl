...
#include <ATen/native/sycl/Sort.h>
...
static int minimum_grid_for_occupancy(T kernel, int max_block_size) {
  int minGridSize = 0;
  int blockSize = 0;
  C10_SYCL_CHECK(// SYCL: occupancy query not directly available
...
struct SmallBitonicSort {
  ...
  void sort(
      at::sycl::detail::TensorInfo<K, IndexType> keyInfo,
      IndexType keySlices,
      IndexType keySliceSize,
      IndexType keySliceStride,
      at::sycl::detail::TensorInfo<V, IndexType> valueInfo,
    ...
    sycl::range<3> block(block_x, block_y);
...
#define HANDLE_SORT_CASE(TYPE, A)                   \
  ...
  AT_DISPATCH_ALL_TYPES_AND3(at::ScalarType::Half, at::ScalarType::BFloat16, at::ScalarType::Bool, key.scalar_type(), "sortKeyValueInplace", [&]  {
    if (at::sycl::detail::canUse32BitIndexMath(key)) {
      at::sycl::detail::TensorInfo<scalar_t, unsigned int> keyInfo =
        at::sycl::detail::getTensorInfo<scalar_t, unsigned int>(key);
      at::sycl::detail::TensorInfo<int64_t, unsigned int> valueInfo =
        at::sycl::detail::getTensorInfo<int64_t, unsigned int>(value);
      ...
      at::sycl::detail::TensorInfo<scalar_t, uint64_t> keyInfo =
        at::sycl::detail::getTensorInfo<scalar_t, uint64_t>(key);
      at::sycl::detail::TensorInfo<int64_t, uint64_t> valueInfo =
        at::sycl::detail::getTensorInfo<int64_t, uint64_t>(value);
