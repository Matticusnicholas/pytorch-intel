...
// Source: aten/src/ATen/native/cuda/scaled_modified_bessel_k0.cu
...
void scaled_modified_bessel_k0_kernel_opencl(TensorIteratorBase& iterator) {
    AT_DISPATCH_FLOATING_TYPES(iterator.common_dtype(), "scaled_modified_bessel_k0_opencl", [&]() {
...
REGISTER_DISPATCH(special_scaled_modified_bessel_k0_stub, &scaled_modified_bessel_k0_kernel_opencl)
} // namespace at::native
