...
// Source: aten/src/ATen/native/cuda/chebyshev_polynomial_t.cu
...
namespace at::native {
        namespace {
            ...
            void chebyshev_polynomial_t_kernel_opencl(TensorIteratorBase& iterator) {
                AT_DISPATCH_FLOATING_TYPES(iterator.common_dtype(), "chebyshev_polynomial_t_opencl", [&]() {
            ...
            } // chebyshev_polynomial_t_kernel_opencl
        } // namespace (anonymous)

        REGISTER_DISPATCH(chebyshev_polynomial_t_stub, &chebyshev_polynomial_t_kernel_opencl)
} // namespace at::native
