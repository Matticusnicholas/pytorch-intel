...
// Source: aten/src/ATen/native/cuda/modified_bessel_i1.cu
...
void modified_bessel_i1_kernel_opencl(TensorIteratorBase& iterator) {
    AT_DISPATCH_FLOATING_TYPES(iterator.common_dtype(), "modified_bessel_i1_opencl", [&]() {
...
REGISTER_DISPATCH(special_modified_bessel_i1_stub, &modified_bessel_i1_kernel_opencl)
} // namespace at::native
