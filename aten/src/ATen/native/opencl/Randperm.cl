...
// Source: aten/src/ATen/native/cuda/Randperm.cu
...
#include <ATen/native/sycl/Randperm.h>
...
Tensor& randperm_out_opencl(int64_t n, std::optional<Generator> generator, Tensor& result) {
  ...
  if (n == 0) {
    ...
    AT_DISPATCH_ALL_TYPES_AND(kHalf, result.scalar_type(), "randperm_out_opencl", [&] {
      ...
      at::sycl::onedpl::radix_sort_pairs<int, dtype>(
    ...
    AT_DISPATCH_ALL_TYPES_AND(kHalf, result.scalar_type(), "randperm_out_opencl", [&] {
      ...
      at::sycl::onedpl::radix_sort_pairs<int64_t, dtype>(
